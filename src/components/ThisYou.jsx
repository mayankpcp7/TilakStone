...
const ThisYou = () => {
  return (
    <div className="relative pt-10 md:pt-20">
      ...
      />
      <div className="container max-w-[1140px] mx-auto md:px-3 sm:px-[60px] lg:px-3 pt-5 md:pt-10 lg:pt-5">
        <h1 className="font-plusJkarta text-black text-2xl md:text-5xl font-bold leading-lg text-center mb-10">
          Is this You?
        </h1>
        <div className="flex flex-row flex-wrap">
          {ThisYouData.map((thisYou, index) => {
            ...
            return (
              ...
              >
                <div className="w-full relative z-30 gap-3 flex items-center bg-white group mx-auto md:mx-0 h-full shadow-[0px_4px_16px_0px_#0000000F] p-[20px] duration-300 min-h-[117px] md:min-h-[130px] hover:bg-[#ecc744] border border-[#dedede] hover:border-[#bf9602] rounded-2xl">
                  <img
                    className={`w-[56px] md:w-[64px]  ${customClass}`}
                    src={thisYou.emoji}
                    alt="Emojis"
                  />
