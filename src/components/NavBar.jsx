          ...
          >
            {navBarVisible ? (
              <div className="flex lg:hidden flex-col relative z-50 justify-between w-[25px]  h-[25px] sm:w-[45px] sm:h-[45px] p-[5.99px_3.39px] sm:p-[10.78px_6.09px] cursor-pointer">
                <span
                  className={`bg-black w-full max-w-[18px] rounded-md sm:max-w-8 h-[3px] sm:h-1 absolute top-[50%] left-[50%]  translate-x-[-50%] translate-y-[-50%] transition-all ease-linear duration-300 ${
                    navBarVisible && "rotate-45"
                  }`}
                ></span>
                <span
                  className={`bg-black w-full max-w-[18px] rounded-md sm:max-w-8 h-[3px] sm:h-1 absolute top-[50%] left-[50%]  translate-x-[-50%] translate-y-[-50%]  transition-all ease-linear duration-300 ${
